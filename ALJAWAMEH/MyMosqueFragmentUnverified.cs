...
namespace ALJAWAMEH
{
    public class MyMosqueFragmentUnverified : Android.Support.V4.App.Fragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var v = inflater.Inflate(Resource.Layout.MyMosqueFragmentUnVerified, container, false);
