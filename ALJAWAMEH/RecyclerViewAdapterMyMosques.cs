...
namespace ALJAWAMEH
{
    class RecycleViewHolderMyMosques : RecyclerView.ViewHolder
    {
        ...
        public RecycleViewHolderMyMosques(View itemView, Action<int> listener) : base(itemView)
        {
    ...
    class RecyclerViewAdapterMyMosques : RecyclerView.Adapter
    {
        private List<DataMyMosques> lstData = new List<DataMyMosques>();
        public event EventHandler<int> ItemClick;
        public RecyclerViewAdapterMyMosques(List<DataMyMosques> lstData)
        {
        ...
        {
            RecycleViewHolderMyMosques viewHolder = holder as RecycleViewHolderMyMosques;
        ...
        public override RecyclerView.ViewHolder OnCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            View itemview = inflater.Inflate(Resource.Layout.itemMyMosques, parent, false);
           
            return new RecycleViewHolderMyMosques(itemview,OnClick);
        }
